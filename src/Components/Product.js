...
class Product extends Component {
  ...
  addLikes = () => {
    this.setState((prevState) => ({
      product: { ...prevState.product, like: prevState.product.like + 1 },
    }));
  };
  updateQuantity = (newQuantity) => {
    this.setState((prevState) => ({
      product: { ...prevState.product, quantity: newQuantity },
    }));
  };
  render() {
    return (
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <Button
              variant="primary"
              onClick={() =>
                this.props.buyFunction(this.state.product, this.updateQuantity)
              }
